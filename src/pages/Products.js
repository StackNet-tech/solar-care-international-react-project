...
const Products = () => {
  ...
  const productList = [
    {
      ...
      image: '/images/products/Asset_8.png',
      price: 110.0,
      stock: true,
    ...
    },
    {
      ...
      stock: true,
      category: 'robots',
      link: 'https://solarcleano.com/en/products/solar-panel-cleaning-robot-f1',
      Description: 'Add your Description'
    },
    {
      id: 9,
      ...
      image: '/images/products/Asset_10.png',
      price: 110.0,
      stock: true,
      category: 'cleaning chemical',
    ...
    },
    {
      ...
      image: '/images/products/Asset_2.png',
      price: 110.0,
      stock: true,
      category: 'cleaning chemical',
    ...
    },
    {
      ...
      image: '/images/products/Asset_5.png',
      price: 110.0,
      stock: true,
      category: 'panels',
      link: 'https://www.chemitek.pt/products/lichen-removal-agent',
    ...
    },
    {
      ...
      name: 'Longi Solar',
      description: 'This is a great product.',
      image: '/images/products/Asset_6.png',
      price: 110.0,
      stock: true,
      category: 'panels',
      link: 'https://www.chemitek.pt/products/lichen-removal-agent',
    ...
    },
    {
      ...
      name: 'SolarCleano M1',
      description: 'This is a great product.',
      image: '/images/products/Asset_7.png',
      price: 110.0,
      stock: true,
      category: 'robots',
      link: 'https://www.chemitek.pt/products/lichen-removal-agent',
  ...
  {filteredProducts.map((product) => (
    <div
      key={product.id}
      className="flex flex-col md:flex-row justify-between gap-4 items-start bg-white rounded-lg shadow dark:bg-gray-800"
      data-aos="fade-up"
    >
